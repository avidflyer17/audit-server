(() => {
  ...
  // audits/scripts/modules/services/data.js
  ...
  var ServiceStore = createListStore({
    sort: "az",
    search: "",
    filterFunc(service) {
      return this.activeCats.has(service.category) && service.name.toLowerCase().includes(this.search);
    },
    sortFunc(list) {
      if (this.sort === "az")
  ...
  var data_default = ServiceStore;

  // audits/scripts/modules/services/ui.js
  ...
  function handleServicesListClick(e) {
    ...
    if (copyBtn) {
      e.stopPropagation();
      navigator.clipboard.writeText(copyBtn.dataset.name).then(() => alert("Copi\xE9 dans le presse-papiers !"));
      return;
    }
  ...
  function renderServicesList() {
    const list = data_default.getFiltered();
  ...
  function initServicesUI() {
    ...
    SERVICE_CATEGORIES.forEach((cat) => {
      ...
      chip.addEventListener("click", () => {
        data_default.toggleCategory(cat);
    ...
    searchInput.addEventListener("input", (e) => {
      data_default.setSearch(e.target.value);
      renderServicesList();
    });
    sortSelect.addEventListener("change", (e) => {
      data_default.setSort(e.target.value);
      renderServicesList();
    });
    document.getElementById("resetFilters").addEventListener("click", () => {
      data_default.resetFilters();
      searchInput.value = "";
      sortSelect.value = "az";
  ...
  // audits/scripts/modules/theme.js
  function initTheme() {
